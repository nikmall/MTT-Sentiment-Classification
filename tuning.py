...
def objective(trial):
    ...
    param_mtt_fuse = {
        ...
        "dec_emb_dim": 300,
        "hid_dim": 300,
        "enc_layers": trial.suggest_int("enc_layers", 2, 5),
        "dec_layers": trial.suggest_int("dec_layers", 2, 5),
        ...
        "enc_dropout": trial.suggest_float("enc_dropout", 0.10, 0.40, step=0.01),
        "dec_dropout": trial.suggest_float("dec_dropout", 0.10, 0.40, step=0.01),
        "att_dropout": trial.suggest_float("att_dropout", 0.05, 0.40, step=0.01),

        "sent_hid_dim": trial.suggest_int("sent_hid_dim", 90, 208),
        "sent_final_hid": trial.suggest_int("sent_final_hid", 80, 168),
        "sent_dropout": trial.suggest_float("sent_dropout", 0.10, 0.40, step=0.01),
        ...
        'loss_dec_cycle_weight': trial.suggest_float("loss_dec_cycle_weight", 0.06, 0.14, step=0.01),
